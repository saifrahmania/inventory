<?php
  ...
  if(isset($_GET['cid'])){
    $id = $_GET['cid'];
    $v_query = "SELECT * FROM categories WHERE cid ='$id'";
    ...
    {
      $brandname = $_POST['cat_name'];
      //$status = $_POST['status'];
      $query = "UPDATE categories SET category_name='$brandname' where cid ='$id'";
      ...
      <div class="col-lg-6">
        <div  id="form_brand" >
          ...
          <?php 
              if(isset($wrng_pass))
              {
                  echo '<h6 class= "wrng_pass text-center" >' .$wrng_pass. '</h6>' ;
              }
          ?>
          <div class="modal-body">
            <form id="brand_form" method="POST">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="cat_name" value="<?php echo $cname;?>">
              </div>
