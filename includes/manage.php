...
class Manage
{
	...
	public function storeCustomerOrderInvoice($orderdate,$cust_name,$ar_tqty,$ar_qty,$ar_price,$ar_pro_name,$sub_total){
		$pre_stmt = $this->con->prepare("INSERT INTO invoice(customer_name, order_date, sub_total) VALUES (?,?,?)");
		$pre_stmt->bind_param("ssd",$cust_name,$orderdate,$sub_total);
		$pre_stmt->execute() or die($this->con->error);
